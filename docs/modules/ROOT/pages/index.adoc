...
| `quarkus.idempotency.problem-base-uri` | `https://docs.quarkiverse.io/quarkus-http-idempotency/dev/` | Documentation base URI used in the `type`/`Link` of `problem+json` errors. See <<errors>>.
